...
/**
 * Factory for building {@link TransferRequest} objects for common test scenarios.
 *
 * Provides descriptive factory methods so tests remain concise and readable.
 *
 * Example:
 *
 * <pre>{@code
 * TransferRequest request =
 *         TransferRequestBuilder.validTransfer(sourceId, destinationId);
 *
 * TransferRequest insufficientFundsRequest =
 *         TransferRequestBuilder.exceedingBalance(
 *                 sourceId,
 *                 destinationId,
 *                 sourceBalance);
 * }</pre>
