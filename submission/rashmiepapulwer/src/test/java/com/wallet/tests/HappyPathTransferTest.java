...
class HappyPathTransferTest extends WalletTransferTestBase {
    ...
    void successfulTransfer_apiWalletBalanceMatchesDb() {
        ...
        BigDecimal apiSourceBalance = new BigDecimal(sourceWalletResponse.jsonPath().getString("balance"));
        ...
        BigDecimal apiDestBalance = new BigDecimal(destWalletResponse.jsonPath().getString("balance"));
